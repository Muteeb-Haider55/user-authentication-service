...
} from "../mailtemplates/emailTemp.js";
//signup
...
export const register = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      //text: `Thanku for creating account. Your account has been created with email id: ${email}`,
    };
...
export const login = async (req, res) => {
  ...
  if (!email || !password) {
    return res.json({
      success: false,
      message: "email and password is requireds",
    });
  }
...
export const sendResetOtp = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: PASSWORD_RESET_REQUEST_TEMPLATE.replace("{resetOtp}", otp),
